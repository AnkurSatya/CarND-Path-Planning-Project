...
static double SEARCH_DISTANCE= 40.0;//(in meters) Search distance for the vehicles in a lane. It decides whether to take a vehicle in consideration or not.
static double BUFFER_DISTANCE = 6.0;//(in meters) Distance to maintain between the vehicles.
static double MAX_SPEED = (45.0 * 1.60934 * 5.0/18.0);//in m/s.
static double MAX_ACCELERATION = 10;//in m/s^2.
static double MAX_COST = 1e10;
static int previous_path_waypoints = 42;
