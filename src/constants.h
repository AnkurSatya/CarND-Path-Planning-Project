...
static double SEARCH_DISTANCE= 200.0;//(in meters) Search distance for the vehicles in a lane. It decides whether to take a vehicle in consideration or not.
static double BUFFER_DISTANCE = 10.0;//(in meters) Distance to maintain between the vehicles along the heading.
